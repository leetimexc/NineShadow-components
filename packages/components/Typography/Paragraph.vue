<template>
  <p ref="containerRef" class="ns-paragraph">
    <span ref="textRef" class="ns-paragraph__text"><slot /></span>
    <NsIcon v-if="copyable" icon="copy" @click="handleCopy" />
    <span v-if="moreable" class="ns-paragraph__more" @click="isOpen = !isOpen">
...
import type { paragraphProps, paragraphEmits } from './types'
import { ref, watch, getCurrentInstance, onMounted } from 'vue'
// import { useClipboard, useElementSize } from '@vueuse/core'

defineOptions({ name: 'NsParagraph' })
