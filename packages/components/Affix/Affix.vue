<template>
  <div ref="rootRef" class="ns-affix" :style="calcRootStyle">
    <div
      :class="['ns-affix__position', { 'ns-affix__position--active': isFixed }]"
...
import type { AffixProps, TargetRect } from "./types";
import { isWindow, getTargetRect } from "@shadow-ui/utils";
