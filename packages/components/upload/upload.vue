  ...
  <div :class="bem()">
    ...
    <div v-if="!isPicture" :class="bem('files')">
      ...
      <div v-if="!draggable" :class="bem('file')">
        ...
        <ns-text type="third">{{ desc }}</ns-text>
      </div>
      <!-- dragger uploader -->
    ...
    <!-- picture list -->
    <ns-space v-if="isPicture && !draggable" wrap :size="8">
...
import { NsImagePreviewGroup } from "../../image";
import { IconUpload2Outline, IconPlusOutline } from "../../svg-icon";
import NsModal from "../../modal";
import NsButton from "../../button";
import { NsText } from "../../typography";
import { NsSpace } from "../../space";
defineOptions({
  name: "NsUpload",
});
