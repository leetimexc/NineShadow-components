...
<template>
  ...
  >
    ...
    <ns-form-item label="Password" prop="password">
      <ns-input v-model="form.password" type="password" />
    </ns-form-item>
    <ns-form-item label="Password Confirm" prop="passwordConfirm">
      <ns-input v-model="form.passwordConfirm" type="password" />
    </ns-form-item>
    <ns-form-item>
      <ns-button type="primary" native-type="submit">Create</ns-button>
